...
# -*- coding: utf-8 -*-
#
# Make distribution packages for alfred extension
#
...
def do_src_archive(dirname, targetdir):
    ...
    for f in files:
        ...
        if os.path.dirname(relfile):
            _create(os.path.join(targetdir, os.path.dirname(relfile)))
